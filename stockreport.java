    ...
    try
      {
          ...
          rs=st.executeQuery("select * from stock order by stock_id");
          
          BufferedWriter bw=new BufferedWriter(new FileWriter("Stockreport.html"));
          ResultSetMetaData rsm=rs.getMetaData();
          int cols=rsm.getColumnCount();
          bw.write("<center><h2><font color=green>PLANT NESERY MANAGEMENT SYSTEM</font></h2>");
          bw.write("<center><h3><u><b><font color=green>PLANTS STOCK REPORT</font></b></u></h3></center>");
